...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        private InputAction m_GrenadeAction;
        ...
        void Start()
        {
            ...
            m_GrenadeAction = InputSystem.actions.FindAction("Player/Grenade");
            ...
            if (m_GrenadeAction != null) m_GrenadeAction.Enable();
        }
        ...
        {
            if (CanProcessInput() && !FireInputBlocked)
            {
        ...
        public bool GetGrenadeInputDown()
        {
            if (CanProcessInput())
            {
                if (m_GrenadeAction != null)
                    return m_GrenadeAction.WasPressedThisFrame();
                else
